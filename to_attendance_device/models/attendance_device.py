...
class AttendanceDevice(models.Model):
    ...
    def connect(self):
        ...
        error_msg = False
        try:
            var_name=self._set_zk()
            return var_name.connect()
    ...
    def disableDevice(self,var_name):
        """
        disable (lock) device, ensure no activity when process run
        """
        try:
            return var_name.disable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def enableDevice(self,var_name):
        """
        re-enable the connected device
        """
        try:
            return var_name.enable_device()
        except Exception as e:
            _logger.error(e)
    ...
    def getSerialNumber(self):
        ...
        try:
            var_name=self.connect()
            self.enableDevice(var_name)
            return var_name.get_serialnumber()
        except Exception as e:
            _logger.error(e)
    ...
    def getOEMVendor(self):
        ...
        try:
            var_name=self.connect()
            self.enableDevice(var_name)
            return var_name.get_oem_vendor()
        except Exception as e:
            _logger.error(e)
    ...
    def getFingerprintAlgorithm(self):
        ...
        try:
            var_name=self.connect()
            self.enableDevice(var_name)
            return var_name.get_fp_version()
        except Exception as e:
            _logger.error(e)
    ...
    def getDeviceName(self):
        ...
        try:
            var_name=self.connect()
            self.enableDevice(var_name)
            return var_name.get_device_name()
        except Exception as e:
            _logger.error(e)
    ...
    def setUser(self, uid=None, name='', privilege=0, password='', group_id='', user_id='', card=0):
        try:
            var_name=self.connect()
            self.enableDevice(var_name)
            self.disableDevice(var_name)
            return var_name.set_user(uid, name, privilege, password, group_id, user_id, card)
        except Exception as e:
            _logger.info(e)
    ...
    def delUser(self, uid, user_id):
        ...
        try:
            ...
            self.enableDevice(var_name)
            self.disableDevice(var_name)
            return var_name.delete_user(uid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def upload_finger_templates(self, uid, name, privilege, password, group_id, user_id, fingers):
        ...
        try:
            ...
            self.enableDevice(var_name)
            self.disableDevice(var_name)
            return var_name.save_user_template(user, fingers)
        except Exception as e:
            _logger.error(e)
    ...
    def delFingerTemplate(self, uid, fid, user_id):
        ...
        try:
            ...
            self.enableDevice(var_name)
            self.disableDevice(var_name)
            return var_name.delete_user_template(uid, fid, user_id)
        except Exception as e:
            _logger.error(e)
    ...
    def getAttendance(self):
        ...
        try:
            ...
            self.enableDevice(var_name)
            self.disableDevice(var_name)
            return var_name.get_attendance()
    ...
    def clearAttendance(self):
        ...
        try:
            ...
            self.enableDevice(var_name)
            self.disableDevice(var_name)
            return var_name.clear_attendance()
        except Exception:
            raise ValidationError(_('Could not get attendance data from the device %s') % (self.display_name,))
        finally:
            self.enableDevice(var_name)
    ...
    def action_device_information(self):
        ...
        for r in self:
            try:
                ...
                var_namer = r.with_env(r.env(cr=cr))
                var_name=r.connect()
                r.firmware_version = var_name.get_firmware_version()
                r.serialnumber = var_name.get_serialnumber()
                r.platform = var_name.get_platform()
                r.fingerprint_algorithm = var_name.get_fp_version()
                r.device_name = var_name.get_device_name()
                r.work_code = var_name.get_workcode()
                r.oem_vendor = var_name.get_oem_vendor()
            except Exception as e:
                _logger.error(e)
            finally:
                cr.commit()
